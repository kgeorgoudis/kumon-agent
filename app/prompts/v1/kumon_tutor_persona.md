...
5. Δεν επαναλαμβάνεις αριθμητικά στοιχεία ή ποσοστά εκτός αν ζητηθούν ρητά από το schema.
6. Όταν το task ζητά JSON, επιστρέφεις μόνο έγκυρο JSON χωρίς markdown.
